        ...
        table: {
          ...
          body: [
            ...
            ...this.usuarios.map((data) => [
              ...
              {
                text: data.estado_rg == 1 ? 'Activa' : 'Inactiva',
                style: 'filaDatos',
              },
            ]),
          ],
